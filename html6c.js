...
const fs = require('fs')
const ast_lexer_parser = require('./html6-libs/ast-lexer-parser')
const codegen = require('./html6-libs/codegen')
const token_table = require('./html6-libs/token_table')
...
if (args[1] == '-ast') {
    ...
    codegen.CodeGen(args[0], args[2]+'.html', 'normal')

} else {
    console.log("\n                   HTML 6")
    console.log("------------------------------------------------------")
    console.log("Syntax:       html6c  <options>")
    console.log("------------------------------------------------------\n\n")
    ...
    console.log("<filename>.html6   -o    <filename>            Output is an HTML 5 file (.html)\n")

    console.log("<filename>.html6   -ast                        Show Abstract Syntax Tree (AST)\n\n")
